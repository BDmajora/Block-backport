package bdmajora.backport.testentity.Warden;
...
public class WardenModel extends BenchEntityModel {
	public static useless.dfexample.testentity.Warden.EntityWarden warden;
	...
	public void setLivingAnimations(EntityLiving entityliving, float limbSwing, float limbYaw, float renderPartialTicks) {
		...
		if (entityliving instanceof useless.dfexample.testentity.Warden.EntityWarden) {
			warden = (useless.dfexample.testentity.Warden.EntityWarden) entityliving;
		}
	}
